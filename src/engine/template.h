...
constexpr int BufferWidth = 256;
constexpr int BufferHeight = 256;

constexpr int ScreenWidth = 256 * ScreenScalingFactor;
constexpr int ScreenHeight = 256 * ScreenScalingFactor;
// #define FULLSCREEN
